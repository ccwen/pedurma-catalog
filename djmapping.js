// djmapping.js // read jinglu.json, construct DJ and JD
// djmaping('1@1b1') ==> "J1:1@1b1"
// djmaping('4@302a5') ==> "J10:4@306a6"
// djmaping('31@297a6') ==> "J1:36@75a2"
// given D 2@3a5 ==> lineId((4339+line('3a5'-8))/17062*19999-5009+9) ==> J 2@
// DJ[  "1"].k	==> "1" (D1 ==> K1)
// DJ[  "1"].d	==> "1"
...
'strict'
/////////////////////////////////////////////////////////////////////////////
function assert(evaluated,expected) { var v
...
/////////////////////////////////////////////////////////////////////////////
function line(lineId,linesPerPage){var m, page, side, ln
	m=lineId.match(/(\d+)([ab])(\d)/), page=m[1], side=m[2], ln=m[3]
	page=parseInt(page), side=(side==='a'?0:1), ln=parseInt(ln)
	return ((page-1)*2+side)*linesPerPage+ln
}
/////////////////////////////////////////////////////////////////////////////
// line('001b1',7) ==> ((1-1)*2+1)*7+1 ==> 8
assert("line('1b1',7)",8)
// line('311a6',7) ==> ((311-1)*2+0)*7+6 ==> (310*2)*7+6 ==> 620*7+6 ==> 4346
assert("line('311a6',7)",4346)
/////////////////////////////////////////////////////////////////////////////
function lineId(line,linesPerPage){ var Ln,Page,Side
	Ln=line%linesPerPage, Page=(line-Ln)/linesPerPage
	Side=Page%2, Page=(Page-Side)/2, Side=Side?'b':'a'
	return (Page+1)+Side+Ln
}
/////////////////////////////////////////////////////////////////////////////
assert("lineId(8,7)",'001b1')
assert("lineId(4346,7)",'311a6')
/////////////////////////////////////////////////////////////////////////////
function lineRange(lineRangeId,linesPerPage){var m, b, e
	m=lineRangeId.match(/(\d+[ab]\d)-(\d+[ab]\d)/)
	b=line(m[1],linesPerPage), e=line(m[2],linesPerPage)
	return {bgn:b, end:e}
}
/////////////////////////////////////////////////////////////////////////////
assert('lineRange("1b1-311a6",7)',{"bgn":8,"end":4346})
/////////////////////////////////////////////////////////////////////////////
function volRanges(volRangesId,linesPerPage){var m, r, volLines, L, bookLines=0, result=[]
	volRangesId.split(';').forEach(function(range){
		m=range.split(/@/), vol=m[0], volRangeId=m[1]
		r=lineRange(volRangeId,linesPerPage)
...
jinglu.forEach(function(CK){var k,d,j,f,m,x,id,a,dv,DJD,jv,JDJ,dj,jd,r,n,dvn,jvn
	k=d=j='' 
	for(f in CK){
		if(m=f.match(/^(K|D|J)(\d+)([a-z]?)/)){ // match only for fields K, D, or J
			x=m[1], id=parseInt(m[2]), a=m[3]
			if(x==='K'){
				k=id+a // K id
			}else if(x==='D'){
...
// djmaping('4@302a5') ==> "J1:36@75a2"
// searching D 31@297a6 founded in dj (K28)
// D11 31@207b1-297a6;32@1b1-397a7 1258/6803 31@297a6
// J12 36@1b1-92a8;37@93b1-400a7 1177/6367 36@75a2 djmapping.js:212
// djmaping('32@397a7') ==> "J4:37@400a7"
// searching D 32@397a7 founded in dj (K28)
// D11 31@207b1-297a6;32@1b1-397a7 6802/6803 32@397a7
// J12 36@1b1-92a8;37@93b1-400a7 6366/6367 37@400a7 djmapping.js:212
